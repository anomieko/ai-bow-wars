  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gray-950">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute top-1/4 -left-32 w-96 h-96 bg-purple-500/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-blue-500/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-4 md:p-8">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 mb-8">
            <h2 className="text-2xl font-bold text-white mb-1">Anomie</h2>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>github.com/anomieko</span>
              </a>

              <a
                href="mailto:anomie.public@gmail.com"
                className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 rounded-xl transition-all text-white"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>anomie.public@gmail.com</span>
              </a>
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10 mb-8">
            <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">Built With</h3>
            <div className="flex flex-wrap justify-center gap-2">
              {['Next.js', 'React Three Fiber', 'Vercel AI Gateway', 'TypeScript', 'Tailwind CSS', 'Zustand'].map((tech) => (
                <span
                  key={tech}
                  className="px-3 py-1.5 bg-white/5 rounded-full text-sm text-gray-300 border border-white/5"
                >
                  {tech}
                </span>
              ))}
